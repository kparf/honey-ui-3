const Carusel__Slide = ({ value, property = "slide", imageProperty = "image", textProperty="text" }) => (

  <div property={property} className="Carusel__slide" mv-multiple="true">
